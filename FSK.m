...
fc1=input('Enter the freq of 1st Sine Wave carrier (in Hz):');
fc2=input('Enter the freq of 2nd Sine Wave carrier (in Hz):');
fp=input('Enter the freq of Periodic Binary pulse (Message) (in m):');
amp=input('Enter the amplitude (For Both Carrier & Binary Pulse Message) (in m):');
amp=amp/2;
